...
var amountPieChartLabels = ["M", "T", "W", "T", "F", "S", "S"];
var amountPieChartTitle = "Type vs Total Amount";
var amountPieChartData = [12, 19, 3, 17, 28, 24, 7];
var amountPieChart;
...
var durationPieChartLabels = ["M", "T", "W", "T", "F", "S", "S"];
var durationPieChartTitle = "Type vs Total Duration (days)";
var durationPieChartData = [12, 19, 3, 17, 28, 24, 7];
...
function updatePieCharts( input ){
	...
	for( var i = 0; i < input.length; i++ ){
		if (  input[i].START_DATE.getTime() >= startDate.getTime() && input[i].REAL_END_DATE.getTime() <= endDate.getTime() ){
	...
	amountPieChartLabels.push("Other");
	...
	durationPieChartLabels.push("Other");
	...
	for ( var i = 0; i < durationPieChartLabels.length; i++ ){
		durationPieChartData[i] = parseFloat(durationPieChartData[i]) / 60.0 / 24.0;
